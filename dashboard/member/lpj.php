            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 hidden-sm hidden-xs">
                    <div class="tab-content-details mg-b-30">
                        <h2>Laporan Pertanggung Jawaban <br>Dana Bantuan Keuangan Partai Politik</h2>
                    </div>
                </div>
                <div class="hidden-lg hidden-md col-sm-12 col-xs-12">
                    <div class="tab-content-details mg-b-30">
                        <h2>Laporan Pertanggung Jawaban <br>Dana Bantuan Keuangan <br>Partai Politik</h2>
                    </div>
                </div>
            </div>
            <div class="row"><!-- first row -->

                <?php include ('../../lmnts/mem-lpj.php'); ?>

                <?php include ('../../lmnts/mem-lpjm.php'); ?>
