...
if ($allData->rowCount() < 1) {
    ...
    $pData      = $allData->fetchAll(PDO::FETCH_ASSOC); //data proposal = $pData
}
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 hidden-sm hidden-xs">
                <div class="tab-content-details mg-b-30">
                    <h2>Rancangan Anggaran Belanja <br>Dana Bantuan Keuangan Partai Politik</h2>
                </div>
            </div>
            <div class="hidden-lg hidden-md col-sm-12 col-xs-12">
                <div class="tab-content-details mg-b-30">
                    <h2>Rancangan Anggaran Belanja <br>Dana Bantuan Keuangan <br>Partai Politik</h2>
                </div>
            </div>
        </div>
        <div class="row">
