                    ...
                    <div class="card collapse-icon panel mb-0 box-shadow-0 border-0">
                        ...
                        <div id="heading11" role="tab" class="card-header">
                            <div class="custom-row">
                                <div class="col-lg-3 col-md-3 col-sm-0 col-xs-0 td pad-0-1">
                                    <span> </span>
                                </div>
                                <div class="col-lg-1 col-md-1 col-sm-0 col-xs-0 td pad-0-1">
                                    <span class="text-center" style="font-weight: bold;">Total Operasional Sekretariatan</span>
                                </div>
                                <div class="col-lg-1 col-md-1 col-sm-0 col-xs-0 td pad-0-1">
                                    <span class="text-center" style="font-weight: bold;">Realisasi Operasional Sekretariatan</span>
                                </div>
                                <div class="col-lg-1 col-md-1 col-sm-0 col-xs-0 td pad-0-1">
                                    <span class="text-center" style="font-weight: bold;">Total Pendidikan Politik</span>
                                </div>
                                <div class="col-lg-1 col-md-1 col-sm-0 col-xs-0 td pad-0-1">
                                    <span class="text-center" style="font-weight: bold;">Realisasi Pendidikan Politik</span>
                                </div>
                                <div class="col-lg-1 col-md-1 col-sm-0 col-xs-0 td pad-0-1">
                                    <span class="text-center" style="font-weight: bold;">RAB</span>
                                </div>
                                <div class="col-lg-1 col-md-1 col-sm-0 col-xs-0 td pad-0-1">
                                    <span class="text-center" style="font-weight: bold;">Realisasi RAB</span>
                                </div>
                        ...
                        if ($pData != "0") :
                            for ($i = 0; $i < $pCount; $i++) :
                                ...
                                $osRQRY   =
                                    "SELECT prpdt_rea_opskdt.reaops_id AS id
                                ...
                                if ($osRData->rowCount() < 1) {
                                    ...
                                    $osRId = implode($osRData->fetch(PDO::FETCH_ASSOC)); //data proposal = $pData
                                    // fetch data item realisasi Operasional Skretariat=> os items and their corresponding value;
                                    $itmOsRQRY   = "SELECT item_kegiatan.item, item_rea.value FROM item_rea INNER JOIN item_kegiatan ON item_rea.id_item=item_kegiatan.id_item WHERE id_op = :postID";
                                    $itmDataR  = $pdo->prepare($itmOsRQRY);
                                    $itmDataR->bindValue(":postID", $osRId, PDO::PARAM_STR);
                                    $hasilR = $itmDataR->execute();
                                    $dataosR = $itmDataR->fetchAll(PDO::FETCH_ASSOC);
                                    // print("<pre>" . print_r($dataosR, true) . "</pre>");
                                    if ($itmDataR->rowCount() > 0) {
                                        foreach ($dataosR as $data) {

                                            $ttlROS += $data['value'];
                                        }
                                        // print("<pre>" . print_r($ttlROS, true) . "</pre>");
                                    }
                                }
                        ...
                        ?>
                                ...
                                <div id="heading11" role="tab" class="card-header">
                                    <div class="custom-row">
                                        ...
                                        <div class="col-lg-1 font-auto col-md-2 col-sm-0 col-xs-0 td pad-0-15">
                                            <span>Rp <?php echo number_format($ttlOS, 0, ",", ".") . "(" . $pOS . "%)" ?></span>
                                        </div>
                                        <div class="col-lg-1 font-auto col-md-2 col-sm-0 col-xs-0 td pad-0-15">
                                            <span>Rp <?php echo number_format($ttlROS, 0, ",", ".") . "(" . $pROS . "%)" ?></span>
                                        </div>
                                        <div class="col-lg-1 font-auto col-md-2 col-sm-0 col-xs-0 td pad-0-15">
                                            <span class="text-center">Rp <?php echo number_format($ttlPP, 0, ",", ".") . "("  . $pPP . "%)" ?></span>
                                        </div>
                                        <div class="col-lg-1 font-auto col-md-2 col-sm-0 col-xs-0 td pad-0-15">
                                            <span class="text-center">Rp <?php echo number_format($ttlRPP, 0, ",", ".") . "("  . $pRPP . "%)" ?></span>
                                        </div>
                                        <div class="col-lg-1 font-auto col-md-2 col-sm-0 col-xs-0 td pad-0-15">
                                            <span class="text-center">Rp <?php echo number_format($ttlRAB, 0, ",", ".") ?></span>
                                        </div>
                                        <div class="col-lg-1 font-auto col-md-2 col-sm-0 col-xs-0 td pad-0-15">
                                            <span class="text-center">Rp <?php echo number_format($ttlRRAB, 0, ",", ".") ?></span>
                                        </div>
                                        <div class="col-lg-1 font-auto col-md-1 col-sm-0 col-xs-0 td">
                                ...
                                <div id="<?php echo 'accordion' . $i ?>" role="tabpanel" aria-labelledby="heading11" class="panel-collapse panel-ic collapse" aria-expanded="true">
                                    ...
                                    <div class="card-body">
                                        <div class="custom-row">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-0 col-xs-0">
                                                            <table class="row-detail">
                                                                ...
                                                                <?php $totalOs += $data['value'];
                                                                    $totalOsR += $dataosR[$idx]['value'];
                                                                } ?>
                                            ...
                                            <div class="col-lg-12 single-brand "><h1>Data realisasi tidak ditemukan</h1></div>
                                                ');
                                            } ?>
